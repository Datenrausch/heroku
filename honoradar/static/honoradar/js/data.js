...
*/
(function (p) {
    "object" === typeof module && module.exports ? (p["default"] = p, module.exports = p) : "function" === typeof define && define.amd ? define(function () {
        return p
    }) : p("undefined" !== typeof Highcharts ? Highcharts : void 0)
})(function (p) {
    (function (h) {
        h.ajax = function (p) {
            var q = h.merge(!0, {
            ...
            if (!q.url) return !1;
            n.open(q.type.toUpperCase(),
                q.url, !0);
            n.setRequestHeader("Content-Type", p[q.dataType] || p.text);
            h.objectEach(q.headers, function (h, q) {
                n.setRequestHeader(q, h)
            });
            n.onreadystatechange = function () {
                ...
                if (4 === n.readyState) {
                    if (200 === n.status) {
                        h = n.responseText;
                        if ("json" === q.dataType) try {
                            h = JSON.parse(h)
                        } catch (C) {
                            q.error && q.error(n, C);
                            return
                        }
                        return q.success && q.success(h)
                    }
                    q.error && q.error(n, n.responseText)
                }
            };
            try {
        ...
        h.extend(z.prototype, {
            ...
            parseCSV: function (a) {
                function b(a, b, c, d) {
                    ...
                    function g() {
                        h > B || B > q ? (++B, m = "") : (!isNaN(parseFloat(m)) && isFinite(m) ? (m = parseFloat(m), f("number")) : isNaN(Date.parse(m)) ? f("string") :
                ...
                function c(a) {
                    ...
                    a.some(function (a, d) {
                        ...
                        for (var k = 0; k < a.length; k++) {
                            ...
                            else "undefined" !== typeof u[d] ? (g = g.trim(), isNaN(Date.parse(g)) ? !isNaN(g) && isFinite(g) || u[d]++ : u[d]++, g = "") : g += d;
                            "," === d && c++;
                            "." === d && b++
                        }
                    });
                ...
                function f(a, b) {
                    ...
                    for (; g < b; g++)
                        if ("undefined" !== typeof a[g] && a[g] && a[g].length)
                            for (c = a[g].trim().replace(/\//g, " ").replace(/\-/g, " ").replace(/\./g, " ").split(" "), f = ["", "", ""], l = 0; l < c.length; l++) l < f.length && (c[l] = parseInt(c[l], 10), c[l] && (t[l] = !t[l] || t[l] < c[l] ? c[l] : t[l], "undefined" !== typeof m[l] ? m[l] !== c[l] && (m[l] = !1) : m[l] = c[l], 31 < c[l] ? f[l] = 100 > c[l] ? "YY" : "YYYY" : 12 < c[l] && 31 >= c[l] ? (f[l] = "dd", k = !0) : f[l].length || (f[l] = "mm")));
                    if (k) {
                        for (l = 0; l < m.length; l++) !1 !== m[l] ? 12 < t[l] && "YY" !== f[l] && "YYYY" !== f[l] && (f[l] = "YY") : 12 < t[l] &&
                            "mm" === f[l] && (f[l] = "dd");
                        3 === f.length && "dd" === f[1] && "dd" === f[2] && (f[2] = "YY");
                        a = f.join("/");
                        return (d.dateFormats || e.dateFormats)[a] ? a : (G("deduceDateFailed"), "YYYY/mm/dd")
                    }
                    return "YYYY/mm/dd"
                }
                var e = this,
                ...
                var g = d.endRow || Number.MAX_VALUE,
                    ...
                    q = d.endColumn || Number.MAX_VALUE,
                    x, m = 0,
                    v = [],
                    u = {
                        ",": 0,
                ...
                if (k) {
                    ...
                    for (var p = 0, m = a; m <= g; m++) "#" === k[m][0] ? p++ : b(k[m], m - a - p);
            ...
            parseTable: function () {
                ...
                b && ("string" === typeof b && (b = n.getElementById(b)), [].forEach.call(b.getElementsByTagName("tr"), function (a, b) {
            ...
            parseGoogleSpreadsheet: function () {
                ...
                var b = this,
                    ...
                    e = this.chart,
                    d = c.googleSpreadsheetWorksheet || 1,
                    k = c.startRow || 0,
                    t = c.endRow || Number.MAX_VALUE,
                    g = c.startColumn || 0,
                    q = c.endColumn || Number.MAX_VALUE,
                    p = 1E3 * (c.dataRefreshRate || 2);
                4E3 > p && (p = 4E3);
                f && (delete c.googleSpreadsheetKey, a(function (a) {
                    ...
                    for (r = 0; r < h; r++) r >= g && r <= q && (c[r - g] = []);
                    for (r = 0; r < f; r++) d = a[r], h = d.gs$cell.row - 1, p = d.gs$cell.col - 1, p >= g && p <= q && h >= k && h <= t && (n = d.gs$cell || d.content,
                        d = null, n.numericValue ? d = 0 <= n.$t.indexOf("/") || 0 <= n.$t.indexOf("-") ? n.$t : 0 < n.$t.indexOf("%") ? 100 * parseFloat(n.numericValue) : parseFloat(n.numericValue) : n.$t && n.$t.length && (d = n.$t), c[p - g][h - k] = d);
            ...
            parseColumn: function (a, b) {
                var c = this.rawColumns,
                    f = this.columns,
                    e = a.length,
                    d, k, h, g, p = this.firstRowAsNames,
                    n = -1 !== this.valueCount.xColumns.indexOf(b),
                    q, m = [],
                    v = this.chartOptions,
                    u, w = (this.options.columnTypes || [])[b],
                    v = n && (v && v.xAxis && "category" === F(v.xAxis)[0].type || "string" === w);
                ...
                n && a.mixed &&
                    (f[b] = c[b]);
                if (n && u && this.options.sort)
                    for (b = 0; b < f.length; b++) f[b].reverse(), p && f[b].unshift(f[b].pop())
            },
            dateFormats: {
                "YYYY/mm/dd": {
            ...
            parseDate: function (a) {
                ...
                if (b) c = b(a);
                    ...
                    if (e)(b =
                        this.dateFormats[e]) || (b = this.dateFormats["YYYY/mm/dd"]), (d = a.match(b.regex)) && (c = b.parser(d));
                    else
            ...
            getFreeIndexes: function (a, b) {
                ...
                for (a = 0; a < b.length; a += 1)
                    for (d = b[a].getReferencedColumnIndexes(), c = 0; c < d.length; c += 1) f[d[c]] = !1;
            ...
            complete: function () {
                ...
                if (c.complete || c.afterComplete) {
                    ...
                    for (; 0 < e.length;) {
                        ...
                        d = e.indexOf(0); - 1 !== d && e.splice(d, 1);
                    ...
                    if ("category" === b)
                        for (d = 0; d < h.length; d++)
                            for (g = h[d], e = 0; e < g.readers.length; e++) "x" === g.readers[e].configName && (g.readers[e].configName = "name");
                    for (d = 0; d < h.length; d++) {
                        g = h[d];
                        e = [];
                    ...
                    if (c.hasOwnProperty("series"))
                        if ("object" === typeof c.series)
                            for (d = Math.max(c.series.length,
                                    a && a.series ? a.series.length : 0); d--;) e = c.series[d] || {}, c.series[d] = y(e, a && a.series ? a.series[d] : {});
